...
def create_app() -> Any:
    ...
    from services.api-gateway.middleware.correlation import CorrelationIdMiddleware
    app.add_middleware(CorrelationIdMiddleware)
    
    # Add metrics middleware
    from services.api-gateway.middleware.metrics import PrometheusMiddleware
    app.add_middleware(PrometheusMiddleware)
    
    # Add rate limiting middleware if enabled
    if settings.RATE_LIMIT_ENABLED:
        from services.api-gateway.middleware.rate_limit import RateLimitMiddleware
        app.add_middleware(RateLimitMiddleware)
    
    # Add authentication middleware
    from services.api-gateway.middleware.auth import AuthenticationMiddleware
    app.add_middleware(AuthenticationMiddleware)
    
    # Add logging middleware (after correlation ID middleware)
    from services.api-gateway.middleware.logging import LoggingMiddleware
    ...
    from services.api-gateway.api.v1 import router as api_v1_router
